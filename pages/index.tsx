...
import Offer from "../components/Transaction/Offer";
import SortModal from "../components/Transaction/SortModal";
import OfferModal from "../components/Transaction/OfferModal";
...
const Home: NextPage = () => {
  ...
  return (
    <>
      {sortFilter && <SortModal closeModal={setSortFilter} />}
      {showFilters && <FilterModal closeModal={setShowFilters} />}
      {showDetail && <OfferModal closeModal={setShowDetail} />}
          ...
          <div className="delegates__mainContainer">
            <div className="delegates__content">
              ...
              <p className="description">
                ...
                Voluptatum, enim, ad provident similique quaerat voluptates qui
                nam eius, optio facilis quibusdam libero fugit ab! Delectus vero
                quaerat corrupti nihil dolore!
              </p>
              <div className="delegates__filterBar">
                <div className="textInput__wrapper">
                  ...
                  <svg
                    ...
                    className="svg-inline--fa fa-magnifying-glass searchIcon"
                    role="img"
                ...
                <button onClick={() => setShowFilters(true)}>
                  <svg
                    ...
                    className="svg-inline--fa fa-bars-filter"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
                ...
                <button onClick={() => setSortFilter(true)}>
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="far"
                    data-icon="arrow-down-arrow-up"
                    className="svg-inline--fa fa-arrow-down-arrow-up"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
