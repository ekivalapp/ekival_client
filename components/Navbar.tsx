            ...
            <div className="header-pills__container">
              ...
              <div className="header-pills__connected-pills">
                ...
                <div className="profileDropdown__container">
                  <button onClick={() => toggleProfileDropdown(true)}
                    className="profileDropdown__button pillButton"
                  >
                    <span>{ formattedAddress }</span>
                  </button>
                  { showProfileDropdown && (
                    <div ref={profileDropdownWrapperRef} className="profileDropdown__menu">
              ...
              {theme === "light" ? (
                <button onClick={() => setTheme("light")} className="header-pills__user-settings">
                  <Image className="theme-icon" src="/images/theme/sun_icon.svg" width="28" height="28" />
                </button>
              ) : (
                <button onClick={() => setTheme("dark")} className="header-pills__user-settings">
                  <Image className="theme-icon" src="/images/theme/moon_icon.svg" width="28" height="28" />
                </button>
              ) }
            </div>
          </section>
