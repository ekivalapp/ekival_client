...
export default function BalanceCard() {
  ...
  function newTransaction() {
    if (!walletConnected) {
      showSwalMessage("Error", "Wallet not connected", "error");
      return;
    }
    toggleModal(true);
  }
  ...
  return (
    <>
      {isModalOpened && <RequestFormModal closeModal={toggleModal} />}
      <div className="card balance-card">
        {currentWallet && (
          <div className="profile">
            ...
            <p className="text-uppercase wallet-name">
            ...
            <div className="balance">
              ...
              <h3>
                {currentbalance ? fromLovelace(currentbalance?.quantity) : 0}
              </h3>
